    ...
    <form action="" method="post">
            <div class="row" style="margin-top: 30px;">
               <div class="form-group" style="margin-top: 30px;">
                <textarea class="form-control" id=""rows="5" name="message" placeholder="Send Your problem"></textarea>
            </div>
            <div id="messagebtn" class="text-center"><button type="submit" name="submit" VALUES="register now">Message</button></div>
            </div>
        </div>
    </form>
        <!-- contact -->
